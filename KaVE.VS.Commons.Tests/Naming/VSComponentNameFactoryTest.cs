...
using KaVE.VS.Commons.TestUtils.Mocking;
using Moq;
using NUnit.Framework;

namespace KaVE.VS.Commons.Tests.Naming
{
    internal class VsComponentNameFactoryTest
    {
        ...
        public void ShouldConvertSolutionDocumentToRelativeName()
        {
            ...
            documentMock.Setup(doc => doc.DTE)
                        .Returns(
                            MockDTE.CreateSolution(
                                       @"C:\Users\Sven Amann\Documents\Projects\KaVE-Solution\Solution.sln")
                                   .DTE);
